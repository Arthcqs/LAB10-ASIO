...
async def async_get_pairs() -> List[PairModel]:
...
async def async_get_historical_data(symbol: str, interval: str, start_time: int, end_time: int) -> List[HistoricalData]:
...
def get_pairs() -> List[PairModel]:
    return asyncio.run(async_get_pairs())

def get_historical_data(symbol: str, interval: str, start_time: int, end_time: int) -> List[HistoricalData]:
    return asyncio.run(async_get_historical_data(symbol, interval, start_time, end_time))
